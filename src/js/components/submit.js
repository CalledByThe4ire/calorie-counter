...
const createSubmitTemplate = (isSubmitDisabled, isResetDisabled) => {
  return (
...
export default class Submit extends SmartComponent {
  constructor(container, { isSubmitDisabled, isResetDisabled }) {
    super();
    this._container = container;
    this._isSubmitDisabled = isSubmitDisabled;
    this._isResetDisabled = isResetDisabled;
    this._submitHandler = null;
    this._resetHandler = null;
  }
  setSubmitHandler(handler) {
    this._container.addEventListener('submit', handler);
    this._submitHandler = handler;
  }
  setResetHandler(handler) {
    this._container.addEventListener('reset', handler);
  ...
  getTemplate() {
    return createSubmitTemplate(this._isSubmitDisabled, this._isResetDisabled);
  }
}
